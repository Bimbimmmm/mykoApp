...
<div class="main-content columns is-fullheight is-padding-top is-font">
  ...
  <div class="box is-box">
    <div class="box is-button-box">
      ...
      <button onclick="window.location='{{ url('admin') }}'" class="button is-selected  is-font">Administrator</button>
    </div>

    <div class="field has-addons">
      <div class="control is-centered">
        <input class="input" type="text" placeholder="Find Admin">
      </div>
      <div class="control">
    ...
    <table class="table is-centered centered-font is-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center">
            <button onclick="window.location='{{ url('admin/edit', array("$data->id")) }}'" class="button is-selected">
