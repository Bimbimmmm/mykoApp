...
<div class="main-content columns is-fullheight is-padding-top is-font">
  ...
  <div class="box is-box">
    <div class="box is-button-box">
      ...
      <button onclick="window.location='{{ url('fo') }}'" class="button is-selected is-font">Front Office</button>
      <button onclick="window.location='{{ url('admin') }}'" class="button has-background-grey-light is-font">Administrator</button>
    </div>

    <div class="field has-addons">
      <div class="control is-centered">
        <input class="input" type="text" placeholder="Find Front Office">
      </div>
      <div class="control">
    ...
    <table class="table is-centered centered-font is-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center">
            <button onclick="window.location='{{ url('fo/edit', array("$data->id")) }}'" class="button is-selected">
              <span class="icon"><i class="fa fa-edit"></i></span>
            </button>
          </td>
          <td align="center">
            <form action="{{ route('fo.destroy', $data->id)}}" method="POST">
              @csrf
              @method('DELETE')
            <button class="button is-selected">
