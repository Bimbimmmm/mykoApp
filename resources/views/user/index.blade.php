...
<div class="main-content columns is-fullheight is-padding-top is-font">
  ...
  <div class="box is-box">
    ...
    <div class="control">
      <button onclick="window.location='{{ url ('user/add') }}'" class="button is-selected">
        <span class="icon"><i class="fa fa-plus"></i></span>
        <span class="is-font">Add New Account</span>
      </button>
    </div>
    ...
    <table class="table is-centered centered-font is-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center">
            <button onclick="window.location='{{ url('user/edit', array("$data->id")) }}'" class="button is-selected">
