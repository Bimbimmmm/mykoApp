...
<div class="main-content columns is-fullheight is-padding-top is-font">
  ...
  <div class="box is-add-box">
      ...
      <div class="card-content">
        <div class="media">
          ...
          <div class="media-content">
            ...
            <p class="has-text-centered subtitle is-6">Point Required : {{ $dat->caption }}</p>
          </div>
        </div>
    ...
    <div class="is-button-box">
      <button onclick="window.location='{{ url('advertising') }}'" class="button is-selected is-font" >OK</button>
    </div>
  </div>
</div>
@endsection
