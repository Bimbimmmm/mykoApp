...
<div class="main-content columns is-fullheight is-padding-top is-font">
  ...
  <div class="box is-add-box">
    <h3 align="center" class="title is-3"><u>Edit Front Office Account</u></h3>
    @foreach($data as $dat)
    <div class="field">
      <form action="{{ route('fo.update',$dat->id) }}" method="POST">
    @csrf
     @method('PUT')
    ...
    <div class="is-button-box">
      ...
      <button onclick="window.location='{{ url('fo') }}'" class="button has-background-grey-light is-font" >Cancel</button>
    </div>
